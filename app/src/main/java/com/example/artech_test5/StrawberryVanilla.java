...
public class StrawberryVanilla extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "51,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.strawberryvanilla_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        strawberryVanillaHandler(rootView);
        return rootView;
    }

    private void strawberryVanillaHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect16);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("strawberryVanilla");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(StrawberryVanilla.this).commitAllowingStateLoss();
