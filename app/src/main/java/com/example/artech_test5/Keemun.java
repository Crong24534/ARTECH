...
public class Keemun extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "36,0,0";
    private int count = 11;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.keemun_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        keemunImgHandler(rootView);
        return rootView;
    }

    private void keemunImgHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect1);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("keemun");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Keemun.this).commitAllowingStateLoss();
