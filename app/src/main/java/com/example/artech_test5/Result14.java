...
public class Result14 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.result14_fragment, container, false);
        result14ImgHandler(rootView);
        return rootView;
    }

    private void result14ImgHandler(ViewGroup rootView) {
        ...
        ImageView back = (ImageView)rootView.findViewById(R.id.img_back27);
        ImageView home = (ImageView)rootView.findViewById(R.id.img_home27);

        fragmentManager = getActivity().getSupportFragmentManager();
        Fragment myFragment = fragmentManager.findFragmentByTag("result14");
        transaction = fragmentManager.beginTransaction();

        home.setOnClickListener(v -> {
            ((MainActivity)getActivity()).black.setVisibility(View.INVISIBLE);
            transaction.remove(Result14.this).commitAllowingStateLoss();
