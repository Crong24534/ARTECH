...
public class LemonVerbena extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "42,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.lemonverbena_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        lemonVerbenaHandler(rootView);
        return rootView;
    }

    private void lemonVerbenaHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect7);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("lemonVerbena");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(LemonVerbena.this).commitAllowingStateLoss();
