...
public class CaramelRisimo extends Fragment implements ArduinoListener {
    ...
    private void caramelRisimoHandler(ViewGroup rootView) {
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("CaramelRisimo");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(CaramelRisimo.this).commitAllowingStateLoss();
