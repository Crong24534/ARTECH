...
public class TropicStar extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "48,0,0";
    private int count = 11;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.tropicstar_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        tropicStarHandler(rootView);
        return rootView;
    }

    private void tropicStarHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect13);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("tropicStar");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(TropicStar.this).commitAllowingStateLoss();
