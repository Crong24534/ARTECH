...
public class LemonBalm extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "41,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.lemonbalm_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        lemonBalmHandler(rootView);
        return rootView;
    }

    private void lemonBalmHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect6);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("lemonBalm");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(LemonBalm.this).commitAllowingStateLoss();
