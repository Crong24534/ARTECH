...
public class Oolong extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "56,0,0";
    private int count = 13;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.oolong_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        oolongHandler(rootView);
        return rootView;
    }

    private void oolongHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect21);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("oolong");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Oolong.this).commitAllowingStateLoss();
