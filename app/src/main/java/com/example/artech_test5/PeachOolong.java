...
public class PeachOolong extends Fragment implements ArduinoListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.peachoolong_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        peachOolongHandler(rootView);
        return rootView;
    }

    private void peachOolongHandler(ViewGroup rootView) {

        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect25);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("peachOolong");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(PeachOolong.this).commitAllowingStateLoss();
