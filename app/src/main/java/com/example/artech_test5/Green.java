...
public class Green extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "37,0,0";
    int count = ((MainActivity)getActivity()).database[2];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.green_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        greenHandler(rootView);
        return rootView;
    }

    private void greenHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect2);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("green");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Green.this).commitAllowingStateLoss();
