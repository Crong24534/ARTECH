...
public class Chamomile extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "64,0,0";
    int count = ((MainActivity)getActivity()).database[29];

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.chamomile_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        chamomileHandler(rootView);
        return rootView;
    }

    private void chamomileHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect29);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("chamomile");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Chamomile.this).commitAllowingStateLoss();
