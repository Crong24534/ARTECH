...
public class Jasmine extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "62,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.jasmine_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        jasmineHandler(rootView);
        return rootView;
    }

    private void jasmineHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect27);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("jasmine");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Jasmine.this).commitAllowingStateLoss();
