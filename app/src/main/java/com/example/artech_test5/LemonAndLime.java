...
public class LemonAndLime extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "39,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.lemonlime_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        lemonAndLimeHandler(rootView);
        return rootView;
    }

    private void lemonAndLimeHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect4);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("lavender");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(LemonAndLime.this).commitAllowingStateLoss();
