...
public class Blueberry extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "68,0,0";
    int count = ((MainActivity)getActivity()).database[33];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.blueberry_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        blueBerryImagHandler(rootView);
        return rootView;
    }

    private void blueBerryImagHandler(ViewGroup rootView) {

        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect33);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("Blueberry");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Blueberry.this).commitAllowingStateLoss();
