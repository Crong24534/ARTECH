...
public class Hibiscus extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "61,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.hibiscus_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        hibiscusHandler(rootView);
        return rootView;
    }

    private void hibiscusHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect26);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("hibiscus");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Hibiscus.this).commitAllowingStateLoss();
