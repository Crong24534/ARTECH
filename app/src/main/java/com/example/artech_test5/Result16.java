...
public class Result16 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.result16_fragment, container, false);
        result16ImgHandler(rootView);
        return rootView;
    }
    private void result16ImgHandler(ViewGroup rootView) {
        ...
        ImageView back = (ImageView)rootView.findViewById(R.id.img_back30);
        ImageView home = (ImageView)rootView.findViewById(R.id.img_home30);

        fragmentManager = getActivity().getSupportFragmentManager();
        Fragment myFragment =fragmentManager.findFragmentByTag("result16");
        transaction = fragmentManager.beginTransaction();

        home.setOnClickListener(v -> {
            ((MainActivity)getActivity()).black.setVisibility(View.INVISIBLE);
            transaction.remove(Result16.this).commitAllowingStateLoss();
