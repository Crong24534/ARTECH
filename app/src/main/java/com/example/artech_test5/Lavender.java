...
public class Lavender extends Fragment implements ArduinoListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.lavender_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        lavenderHandler(rootView);
        return rootView;
    }

    private void lavenderHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect3);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Lavender.this).commitAllowingStateLoss();
