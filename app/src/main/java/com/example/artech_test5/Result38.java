...
public class Result38 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.result38_fragment, container, false);
        result38ImgHandler(rootView);
        return rootView;
    }
    private void result38ImgHandler(ViewGroup rootView) {
        ...
        ImageView back = (ImageView)rootView.findViewById(R.id.img_back59);
        ImageView home = (ImageView)rootView.findViewById(R.id.img_home59);

        fragmentManager = getActivity().getSupportFragmentManager();
        Fragment myFragment = fragmentManager.findFragmentByTag("result38");
        transaction = fragmentManager.beginTransaction();

        home.setOnClickListener(v -> {
            ((MainActivity)getActivity()).black.setVisibility(View.INVISIBLE);
            transaction.remove(Result38.this).commitAllowingStateLoss();
