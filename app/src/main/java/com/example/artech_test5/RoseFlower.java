...
public class RoseFlower extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "69,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.roseflower_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        roseFlowerHandler(rootView);
        return rootView;
    }

    private void roseFlowerHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect34);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("roseFlower");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(RoseFlower.this).commitAllowingStateLoss();
