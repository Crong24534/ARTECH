...
public class RoseHip extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "44,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.rosehip_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        roseHipHandler(rootView);
        return rootView;
    }

    private void roseHipHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect9);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("roseHip");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(RoseHip.this).commitAllowingStateLoss();
