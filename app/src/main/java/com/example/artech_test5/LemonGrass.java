...
public class LemonGrass extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "40,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.lemongrass_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        lemonGrassHandler(rootView);
        return rootView;
    }

    private void lemonGrassHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect5);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("lemonGrass");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(LemonGrass.this).commitAllowingStateLoss();
