...
public class PepperMint extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "65,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.peppermint_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        pepperMintHandler(rootView);
        return rootView;
    }

    private void pepperMintHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect30);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("pepperMint");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(PepperMint.this).commitAllowingStateLoss();
