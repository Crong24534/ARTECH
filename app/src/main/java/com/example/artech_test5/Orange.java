...
public class Orange extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value ="49,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.orange_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        orangeHandler(rootView);
        return rootView;
    }

    private void orangeHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect14);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("orange");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Orange.this).commitAllowingStateLoss();
