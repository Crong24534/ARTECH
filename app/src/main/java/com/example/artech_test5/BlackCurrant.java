...
public class BlackCurrant extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "67,0,0";
    int count = ((MainActivity)getActivity()).database[32];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.blackcurrant_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        blackCurrantHandler(rootView);
        return rootView;
    }

    private void blackCurrantHandler(ViewGroup rootView) {

        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect32);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("EarlGrey");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(BlackCurrant.this).commitAllowingStateLoss();
