...
public class Raspberry extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "70,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.raspberry_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        raspberryHandler(rootView);
        return rootView;
    }

    private void raspberryHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect35);
        ...
        Fragment myFragment =fragmentManager.findFragmentByTag("raspberry");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Raspberry.this).commitAllowingStateLoss();
