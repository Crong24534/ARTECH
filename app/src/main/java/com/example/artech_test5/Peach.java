...
public class Peach extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "59,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.peach_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        peachHandler(rootView);
        return rootView;
    }

    private void peachHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect24);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("peach");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Peach.this).commitAllowingStateLoss();
