...
public class Caribbean extends Fragment implements ArduinoListener {
    private Arduino arduino = ((MainActivity)getActivity()).arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "54,0,0";
    int count = ((MainActivity)getActivity()).database[19];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.caribbean_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        ceylonHandler(rootView);
        return rootView;
    }

    private void ceylonHandler(ViewGroup rootView) {


        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect19);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("ceylon");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Caribbean.this).commitAllowingStateLoss();
