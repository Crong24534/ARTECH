...
public class Apple extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "53,0,0";
    int count = ((MainActivity)getActivity()).database[12];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.apple_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        appleImagHandler(rootView);
        return rootView;
    }

    private void appleImagHandler(ViewGroup rootView) {

        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect18);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("Apple");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Apple.this).commitAllowingStateLoss();
