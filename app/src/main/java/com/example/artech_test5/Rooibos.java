...
public class Rooibos extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "10,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.rooibos_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        rooibosHandler(rootView);
        return rootView;
    }

    private void rooibosHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect10);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("rooibos");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Rooibos.this).commitAllowingStateLoss();
