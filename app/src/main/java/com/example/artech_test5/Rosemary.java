...
public class Rosemary extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "43,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.rosemary_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        rosemaryHandler(rootView);
        return rootView;
    }

    private void rosemaryHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect8);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("rosemary");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Rosemary.this).commitAllowingStateLoss();
