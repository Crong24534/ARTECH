...
public class Mate extends Fragment implements ArduinoListener {
    private Arduino arduino;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "46,0,0";
    private int count = 13;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.mate_fragment,container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        mateHandler(rootView);
        return rootView;
    }

    private void mateHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect11);
        ...
        Fragment myFragment = fragmentManager.findFragmentByTag("mate");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(Mate.this).commitAllowingStateLoss();
