...
public class RichOolong extends Fragment implements ArduinoListener {
    private Arduino arduino ;
    private FragmentManager fragmentManager;
    private FragmentTransaction transaction;
    private Gif gif;
    private String value = "55,0,0";
    private int count = 13;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.richoolong_fragment, container, false);
        arduino = new Arduino(getActivity().getApplicationContext());
        richOolongHandler(rootView);
        return rootView;
    }

    private void richOolongHandler(ViewGroup rootView) {
        ImageView teaSelect = (ImageView)rootView.findViewById(R.id.teaSelect20);
        ...
        Fragment myFragment =fragmentManager.findFragmentByTag("richOolong");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(RichOolong.this).commitAllowingStateLoss();
